...
import {logoutFirebase, resetPassword} from "../config/firebase-config";
        ...
        <div className="container mt-20 mx-auto p-6">
            ...
            <div className="flex flex-col items-center space-y-4">
                <div className="flex items-center space-x-4">
                    <div
                        className="flex-shrink-0 h-16 w-16 rounded-full bg-pink-500 flex items-center justify-center text-white font-bold text-xl">
