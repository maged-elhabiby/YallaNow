                ...
                <div className="mx-auto max-w-8xl px-10 lg:px-10">
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Groups
                                Center</h2>
                        </div>
                        {/* Link wrapping the button for navigation */}
                        <Link to="/create-group"
                              className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-pink-600 hover:bg-pink-700">
                            Create a Group
                        </Link>
                    </div>
