    ...
    return (
        <div className="flex flex-col min-h-screen overflow-hidden">
            ...
            <section className="relative" style={{
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6">
                    <div className="pt-32 pb-12 mb-20 md:pt-40 md:pb-20 text-center text-white">
                        ...
                        <p className="text-xl">Connect, plan, and celebrate events effortlessly with friends and
                            family.</p>
                        <div className="mt-8">
                            <button onClick={handleGetStartedClick}
                                    className="bg-pink-600 text-white rounded-full py-3 px-6">
                                Get Started
                            </button>
                        </div>
                    </div>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">Organize your events with a dedicated space for planning,
                                making collaboration easy and fun.</p>
                        </div>
                        <div className="text-center">
                            <h3 className="text-xl font-semibold mb-2">Finding Communities</h3>
                            <p className="text-gray-600">Create or Join communities to connect with people who share
                                your passions and hobbies.</p>
                        </div>
                        <div className="text-center">
                            <h3 className="text-xl font-semibold mb-2">RSVP</h3>
                            <p className="text-gray-600">RSVP to events with ease and view them from your event calendar
                                to stay organized.</p>
                        </div>
                    </div>
                </div>
            ...
            <section className="bg-gray-100" style={{
                backgroundImage: `url(${testimonialsBackgroundImageUrl})`,
                backgroundSize: 'cover',
                backgroundPosition: 'center',
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 text-white">
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded shadow py-6 px-8 text-gray-600">
                            <p className="italic">"Yalla Now has been a game-changer for finding interesting events in
                                my city. I've met so many new friends!"</p>
                            <div className="mt-4">
                        ...
                        {/* Testimonial 2 */}
                        <div className="bg-white rounded shadow py-6 px-8 text-gray-600">
                            <p className="italic">"Organizing my cooking workshops has never been easier. Yalla Now's
                                tools are incredibly user-friendly."</p>
                            <div className="mt-4">
